...
vim.keymap.set("n", "<localleader>th", "<Plug>(neorg.qol.todo-items.todo.task-on-hold)",      { desc = "neorg: set task to hold",      buffer = true })
...
vim.keymap.set("n", "<localleader>tr", "<Plug>(neorg.qol.todo-items.todo.task-recurring)", { desc = "neorg: set task to recurring", buffer = true })
